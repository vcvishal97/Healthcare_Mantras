...
<title>Admin</title>
<link rel="stylesheet" type="text/css" media="all" href="./Admin Form_files/screen7.css">
...
<input type="text" name="RESULT_TextField-1" class="text_field" id="RESULT_TextField-1" placeholder="Hospital&#39;s  Name" size="80" maxlength="255" value="">
</div>
...
<input type="text" name="RESULT_TextField-2" class="text_field" id="RESULT_TextField-2" placeholder="Hospital&#39;s Address" size="80" maxlength="255" value="">
</div>
...
<input type="text" name="RESULT_TextField-3" class="text_field" id="RESULT_TextField-3" placeholder="Image Url" size="80" maxlength="255" value="">
</div>
...
<input type="text" name="RESULT_TextField-4" class="text_field" id="RESULT_TextField-4" placeholder="Priority" size="80" maxlength="255" value="">
</div>
