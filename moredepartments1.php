...
<li style="padding:20px 16px;font-family:Lucida Sans Unicode;">HEALTHCARE MANTRAS</li>
<div style="float:right;">
<li style="padding:20px 16px;font-family:Lucida Sans Unicode;"><?php echo $var; ?></li>
</div>
...
$sql="select * from departments where department='$var' order by priority";
...
{?>
	...
	<div>
	<img src="Hospitals\ARTEMIS HOSPITAL.jpg"></img>
	</div>
</div>
